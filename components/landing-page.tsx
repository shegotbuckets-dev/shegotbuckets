                ...
                <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
                    <div className="container mx-auto text-center">
                        ...
                        <p className="text-lg sm:text-xl text-gray-600 mb-8">
                            Streamline your waste management processes with our
                    ...
                    <div className="container mx-auto text-center">
                        ...
                        <div className="flex justify-center space-x-4 sm:space-x-8">
                            {[
                                ...
                                <div
                                    key={client}
                                    className="w-10 h-10 sm:w-16 sm:h-16 bg-gray-200 rounded-full"
                                />
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="container mx-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                {
                                    icon: (
                                        <Trash2 className="h-8 w-8 sm:h-10 sm:w-10 text-green-600" />
                                    ),
                                    title: "Waste Audits",
                                    description:
                                        "Comprehensive analysis of waste streams and management practices",
                                },
                                {
                                    icon: (
                                    ...
                                    description:
                                        "Ensure adherence to local and federal waste management regulations",
                                },
                                {
                                    icon: (
                                    ...
                                    description:
                                        "Instant access to inspection results and recommendations",
                                },
                                {
                                    icon: (
                                    ...
                                    description:
                                        "Minimize environmental impact through optimized waste management",
                                },
                            ].map((service, index) => (
                    ...
                    <div className="container mx-auto">
                        ...
                        <div className="max-w-3xl mx-auto space-y-6 sm:space-y-8">
                            {[
                                {
                                    question:
                                        "How often should we conduct waste management inspections?",
                ...
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <nav className="flex flex-wrap justify-center space-x-4 mb-4 md:mb-0">
                            <Link
                                className="text-sm hover:text-green-400 mb-2 md:mb-0"
                                href="#"
                            >
                                Privacy Policy
                            </Link>

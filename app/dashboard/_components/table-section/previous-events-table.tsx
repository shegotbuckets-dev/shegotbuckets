...
function PreviousEventsTableComponent({
    events,
    onButtonSuccess,
    loading,
...
export const PreviousEventsTable = memo(PreviousEventsTableComponent);

PreviousEventsTable.displayName = "PreviousEventsTable";
